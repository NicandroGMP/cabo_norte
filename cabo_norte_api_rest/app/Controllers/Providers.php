...
class Providers extends BaseController
{
    ...
    public function searchServicesByWorkId($id)
    {
        ...
        $join->select('providers.id, providers.name, providers.service, providers.work as work_id, providers.manager as manager_id, CONCAT(works.job," ",works.batch) as job, providers.status as status_provider');
    ...
    {
        $join = $this->providers->table("providers");
        $join->select('providers.id, providers.register_number ,providers.name, providers.service, providers.work as work_id, providers.manager as manager_id, CONCAT(works.job," ",works.batch) as job, providers.status as status_provider');
